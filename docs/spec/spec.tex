...
\begin{longtable}{c c l}
    ...
    \endhead
    \lexentry{\cdot}{.}{Center Dot (Quantifier Separator) \footnote{Anywhere $\cdot$ is valid, $.$ is valid, except the parser may attempt to treat $.$ as a record field access instead of a quantifier separator (like $a.b$), so we prefer the use of $\cdot$ instead.}}
    \lexentry{.}{}{Dot}
