...
\begin{longtable}{c c l}
    ...
    \endhead
    \lexentry{\cdot}{.}{Center Dot (Quantifier Separator)}
    \lexentry{,}{}{Comma}
    \lexentry{:}{}{Colon}
    \lexentry{;}{}{Semicolon}
    ...
    \lexentry{\langle}{<{}<}{Left Angle Bracket}
    \lexentry{}{[}{Left Angle Bracket (Alternative)}
    \lexentry{\rangle}{>{}>}{Right Angle Bracket}
    \lexentry{}{]}{Right Angle Bracket (Alternative)}
    \lexentry{\{}{}{Left Brace}
...
\begin{longtable}{c c c c}
    ...
    \lexentry{:\in}{::}{Non-deterministic Membership Assignment}
...
\infer1{\Gamma \vdash nat \ruleSpace nat = \bSetT{n \geq 0}{n \in int} }
\end{prooftree}
\\
\tag{Int from float}
\begin{prooftree}
...
\infer1{\Gamma \vdash EmptyTuple \subseteq tuple[T]}
\end{prooftree}
\\
...
\infer1{\Gamma \vdash bag[T] = T \pfun nat }
\end{prooftree}
\\
\tag{Bag Enumeration}
\begin{prooftree}
...
\begin{prooftree}
\hypo{\Gamma \vdash T, nat}
\infer1{\Gamma \vdash bag[T] = nat \pfun T }
\end{prooftree}
\\
...
\begin{gather}
\tag{Boolean Operations - Equivalence}
\begin{prooftree}
\hypo{\Gamma \vdash b_1, b_2: bool}
\infer1{\Gamma \vdash b_1 \equiv b_2 : bool}
\end{prooftree}
\\
\tag{Boolean Operations - Not Equivalence}
\begin{prooftree}
\hypo{\Gamma \vdash b_1, b_2: bool}
\infer1{\Gamma \vdash b_1 \not\equiv b_2 : bool}
\end{prooftree}
\\
\tag{Boolean Operations - Implication}
\begin{prooftree}
\hypo{\Gamma \vdash b_1, b_2: bool}
\infer1{\Gamma \vdash b_1 \implies b_2 : bool}
\end{prooftree}
\\
\tag{Boolean Operations - And}
\begin{prooftree}
\hypo{\Gamma \vdash b_1, b_2: bool}
\infer1{\Gamma \vdash b_1 \land b_2 : bool}
\end{prooftree}
\\
\tag{Boolean Operations - Or}
\begin{prooftree}
\hypo{\Gamma \vdash b_1, b_2: bool}
\infer1{\Gamma \vdash b_1 \lor b_2 : bool}
\end{prooftree}
\\
...
\infer1{\Gamma \vdash a_1 = a_2 : bool}
\end{prooftree}
\\
\tag{Not Equals}
\begin{prooftree}
\hypo{\Gamma \vdash a_1: T_1, a_2: T_2}
\infer1{\Gamma \vdash a_1 \neq a_2 : bool}
\end{prooftree}
\\
\tag{Less Than}
\begin{prooftree}
...
\infer2{\Gamma \vdash a_1 < a_2 : bool}
\end{prooftree}
\\
\tag{Less Than or Equal}
\begin{prooftree}
\hypo{\Gamma \vdash a_1, a_2: T}
\hypo{T \in \{int, float, nat\}}
\infer2{\Gamma \vdash a_1 \leq a_2 : bool}
\end{prooftree}
\\
\tag{Greater Than}
\begin{prooftree}
...
\end{prooftree}
\\
\tag{Greater Than or Equal}
\begin{prooftree}
\hypo{\Gamma \vdash a_1, a_2: T}
\hypo{T \in \{int, float, nat\}}
\infer2{\Gamma \vdash a_1 \geq a_2 : bool}
\end{prooftree}
\\
\tag{Set Membership}
\begin{prooftree}
\hypo{\Gamma \vdash a_1: T_1, a_2: set[T_2]}
\infer1{\Gamma \vdash a_1 \in a_2: bool}
\end{prooftree}
\\
\tag{Not Set Membership}
\begin{prooftree}
\hypo{\Gamma \vdash a_1: T_1, a_2: set[T_2]}
\infer1{\Gamma \vdash a_1 \not\in a_2: bool}
\end{prooftree}
...
\begin{gather}
\tag{Set Operations - Subset}
\begin{prooftree}
\hypo{\Gamma \vdash a_1: set[T_1], a_2: set[T_2]}
\infer1{\Gamma \vdash a_1 \subset a_2: bool}
\end{prooftree}
\\
\tag{Set Operations - Subset Equal}
\begin{prooftree}
\hypo{\Gamma \vdash a_1: set[T_1], a_2: set[T_2]}
\infer1{\Gamma \vdash a_1 \subseteq a_2: bool}
\end{prooftree}
\\
\tag{Set Operations - Superset}
\begin{prooftree}
\hypo{\Gamma \vdash a_1: set[T_1], a_2: set[T_2]}
\infer1{\Gamma \vdash a_1 \supset a_2: bool}
\end{prooftree}
\\
\tag{Set Operations - Superset Equal}
\begin{prooftree}
\hypo{\Gamma \vdash a_1: set[T_1], a_2: set[T_2]}
\infer1{\Gamma \vdash a_1 \supseteq a_2: bool}
\end{prooftree}
\\
\tag{Set Operations - Not Subset}
\begin{prooftree}
\hypo{\Gamma \vdash a_1: set[T_1], a_2: set[T_2]}
\infer1{\Gamma \vdash a_1 \not\subset a_2: bool}
\end{prooftree}
\\
\tag{Set Operations - Not Subset Equal}
\begin{prooftree}
\hypo{\Gamma \vdash a_1: set[T_1], a_2: set[T_2]}
\infer1{\Gamma \vdash a_1 \not\subseteq a_2: bool}
\end{prooftree}
\\
\tag{Set Operations - Not Superset}
\begin{prooftree}
\hypo{\Gamma \vdash a_1: set[T_1], a_2: set[T_2]}
\infer1{\Gamma \vdash a_1 \not\supset a_2: bool}
\end{prooftree}
\\
\tag{Set Operations - Not Superset Equal}
\begin{prooftree}
\hypo{\Gamma \vdash a_1: set[T_1], a_2: set[T_2]}
\infer1{\Gamma \vdash a_1 \not\supseteq a_2: bool}
\end{prooftree}
\\
\tag{Set Operations - Union}
\begin{prooftree}
\hypo{\Gamma \vdash a_1, a_2: set[T]}
\infer1{\Gamma \vdash a_1 \cup a_2: set[T]}
\end{prooftree}
\\
\tag{Set Operations - Intersection}
\begin{prooftree}
\hypo{\Gamma \vdash a_1, a_2: set[T]}
\infer1{\Gamma \vdash a_1 \cap a_2: set[T]}
\end{prooftree}
\\
\tag{Set Operations - Difference}
\begin{prooftree}
\hypo{\Gamma \vdash a_1, a_2: set[T]}
\infer1{\Gamma \vdash a_1 \setminus a_2: set[T]}
\end{prooftree}
\\
...
\infer1{\Gamma \vdash a_1 \upto a_2: set[int, \text{ with } exclude(n)=a_1 < n, \text{ with } exclude(n)=a_2 > n]}
...
\infer1{\Gamma \vdash a_1 \cup a_2: bag[T]}
\end{prooftree}
\\
\tag{Bag Operations - (Min) Intersection}
\begin{prooftree}
\hypo{\Gamma \vdash a_1, a_2: bag[T]}
\infer1{\Gamma \vdash a_1 \cap a_2: bag[T]}
\end{prooftree}
\\
\tag{Bag Operations - Addition}
\begin{prooftree}
\hypo{\Gamma \vdash a_1, a_2: bag[T]}
\infer1{\Gamma \vdash a_1 + a_2: bag[T]}
\end{prooftree}
\\
\tag{Bag Operations - Subtraction}
\begin{prooftree}
\hypo{\Gamma \vdash a_1, a_2: bag[T]}
\infer1{\Gamma \vdash a_1 - a_2: bag[T]}
\end{prooftree}
