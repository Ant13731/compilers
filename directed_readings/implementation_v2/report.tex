...
\begin{itemize}
  ...
  % TODO add more here, need to cover all types of problems
...
% Given that LLVM IR is a programming language in-and-of-itself, effectively lower optimized ASTs into IR.
