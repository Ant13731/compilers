...
#             if not added_enum:
#                 current_env.put(target.name, value._get_type)
...
#             if value._get_type != explicit_type._get_type:
#                 raise SimileTypeError(f"Type mismatch: cannot assign value of type {value._get_type} to explicit type {explicit_type}")
...
#             else:
#                 current_env.put(name, value._get_type)
...
#             current_env.put_nested_struct(assign_names, value._get_type)
...
#                     fields[item.name.name] = item.type_._get_type
...
#                     arg_types[arg.name.name] = arg._get_type

#                 current_env.put(
#                     name,
#                     ProcedureTypeDef(
#                         arg_types=arg_types,
#                         return_type=return_type._get_type,
#                     ),
#                 )
